...
class Pallete {
  ...
  static const textLink = Color(0xFFD32F2F);

  // Icon colors
  static const iconColor = Color(0xFF212121);
  static const iconSuccess = Color(0xFF4CAF50);

  // Card colors
  static const cardBackground = Colors.white;
  static const cardShadow = Colors.black12;
  static const cardAccent = Color(0xFFBBDEFB);
